            ...
            <div ref={contentRef} className="px-6 md:px-12 opacity-0">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-3 font-unbounded text-sm tracking-[0.1em] uppercase bg-white text-black px-10 py-5 rounded-full hover:bg-white/90 transition-all duration-300 cta-glow mb-16"
                    >
